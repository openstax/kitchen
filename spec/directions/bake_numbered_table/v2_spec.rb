...
RSpec.describe Kitchen::Directions::BakeNumberedTable::V2 do
  ...
  let(:caption_with_title) { '<caption>A caption <span data-type="title">Caption title</span></caption>' }
    ...
    expect(top_titled_table.document.search('.os-table').first).to match_normalized_html(
      <<~HTML
        <div class="os-table os-top-titled-container">
          ...
          <table class="top-titled" id="tId" summary="Table 2.3 Caption title A caption ">
            <thead>
              <tr>
                <th>Another heading cell</th>
              </tr>
          ...
          <div class="os-caption-container">
            ...
            <span class="os-title" data-type="title">Caption title</span>
            <span class="os-divider"> </span>
  ...
  it 'bakes another kind of table' do
    ...
    expect(other_table.document.search('.os-table').first).to match_normalized_html(
      <<~HTML
        <div class="os-table ">
          <table class="some-class" id="tId" summary="Table 2.3 Caption title A caption ">
            <thead>
              <tr>
                <th>A title</th>
              </tr>
  ...
  context 'when no caption title' do
    let(:caption) { '' }

    it 'does not include an os-title div' do
      described_class.new.bake(table: top_titled_table, number: '2.3')
      expect(top_titled_table.document).not_to match('os-title')
    end
  end
