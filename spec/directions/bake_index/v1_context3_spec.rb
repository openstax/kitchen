  ...
  context 'when v1 has multiple types in polish books' do
    it 'works' do
      with_locale(:pl) do
        ...
        expect(book_with_polish_letters.body).to match_normalized_html(
          <<~HTML
            <body>
              <div data-type="metadata" style="display: none;">
                <span data-type="revised" id="revised">Revised</span>
              ...
              <div data-type="chapter">
                <div data-type="page" id="p1">
                  <div data-type="document-title"><span>1.1</span> First Page</div>
                    <span data-type="term" id="auto_p1_term1" group-by="c">czosnek</span>
                    <span data-type="term" id="auto_p1_term2" group-by="ć">ćma</span>
                    <span xmlns:cmlnle="http://katalysteducation.org/cmlnle/1.0" data-type="term" cmlnle:reference="ćwiczenie" id="auto_p1_term3" group-by="ć">ćwiczeniu</span>
                    <span xmlns:cmlnle="http://katalysteducation.org/cmlnle/1.0" xmlns:cxlxt="http://katalysteducation.org/cxlxt/1.0" data-type="term" cmlnle:reference="Ćwierkowski, Wilhelm (1832-1920)" cxlxt:index="name" cxlxt:name="Ćwierkowskiego, Wilhelma" cxlxt:born="1832" cxlxt:died="1920" id="auto_p1_term4" group-by="Ć">Wilhelma Ćwierkowskiego</span>
                    <span xmlns:cmlnle="http://katalysteducation.org/cmlnle/1.0" xmlns:cxlxt="http://katalysteducation.org/cxlxt/1.0" data-type="term" cmlnle:reference="Chomsky, Noam (ur. 1928)" cxlxt:index="name" cxlxt:name="Chomsky, Noam" cxlxt:born="1928" id="auto_p1_term5" group-by="C">Noama Chomsky'ego</span>
                </div>
              </div>
