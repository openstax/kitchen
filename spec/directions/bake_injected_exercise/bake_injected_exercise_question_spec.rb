...
RSpec.describe Kitchen::Directions::BakeInjectedExerciseQuestion do
  ...
  context 'when there is an exercise-context figure reference present' do
    it 'moves it to the exercises question after the problem number' do
      book_with_exercise_with_context_figure.chapters.pages.injected_questions.each do |question|
        described_class.v1(question: question, number: question.count_in(:page), figure_reference: true)
      end
