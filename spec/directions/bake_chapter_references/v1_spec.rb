...
RSpec.describe Kitchen::Directions::BakeChapterReferences::V1 do
  ...
  context 'when from_introduction is true the references are baked from non intro pages as well' do
    it 'works' do
      described_class.new.bake(chapter: chapter, metadata_source: metadata_element, from_introduction: true)
      expect(chapter).to match_normalized_html(
        <<~HTML
          <div data-type="chapter">
            <div data-type="page" class="introduction">
