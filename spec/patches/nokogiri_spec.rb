...
RSpec.describe 'Nokogiri patches' do
  ...
  describe 'Nokogiri::XML::Node' do
    ...
    describe '#quick_matches?' do
      it 'works for class selectors' do
        expect(make_nokogiri_node('<div class="bar"/>').quick_matches?('.bar')).to be true
        expect(make_nokogiri_node('<div class="bar"/>').quick_matches?('.foo')).to be false
      end
      ...
      it 'works for attributes with element name' do
        ...
        expect(make_nokogiri_node('<div data-type="foo-bar"/>').quick_matches?("div[data-type='foo-bar']")).to be true
      end
      ...
      it 'freaks out if it gets a type it does not know' do
        ...
        }.to raise_error(/Unrecognized selector .*/)
      end
    end
  end
